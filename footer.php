        ...
        if ($sidebars_count > 0) {
            ...
            if ($footer_layout = mfn_opts_get('footer-layout')) {
                ...
                switch ($sidebars_count) {
                    case 2: $sidebar_class = 'one-second';
                        break;
                    case 3: $sidebar_class = 'one-third';
                        break;
                    case 4: $sidebar_class = 'one-fourth';
                        break;
                    case 5: $sidebar_class = 'one-fifth';
                        break;
                    ...
                    <div class="column one">
                        ...
                        <div class="copyright">
                            ...
                            if (mfn_opts_get('footer-copy')) {
                                ...
                                echo '&copy; ' . esc_html(date('Y')) . ' ' . esc_html(get_bloginfo('name')) . ' Tous droits résérvés, Hi-Tech Corp ';
                            }
                            ?>
                        </div>
                ...
                <div class="container-fluid">
                    <div class="row" style="text-align: center">
                        <div class="col-12 col-md-6">
                            <a  href="tel:+212661760335" class="phone-in-popup button">
                                <span class="tele-text">+212 661 760 335</span>
                                <span class="tele-icon"><i class="icon-phone"></i></span>
                        ...
                        <div class="col-12 col-md-6">
                            <a class="button" href="#bg-contact-devis" id="modal-link-devis">Demander un DEVIS</a>
                        </div>
                        
                        <script type="text/javascript">
                            (function ($) {
                                $('#modal-link-devis').on('click', function () {
//                                       alert('ok ok');

                                    $("#modalSlick").modal('toggle');
                                });
                            })(jQuery);
                        </script>
                    </div>
